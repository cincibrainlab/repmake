...
for i = 1 : height(filelist)
    ...
    setinfo = cell2table({filelist.outputfile(i) ip.Results.nettype ip.Results.ext EEG.nbchan EEG.trials EEG.pnts EEG.srate EEG.xmin ...
        ...
        'VariableNames', {'setname','nettype','original_fmt','nbchan','trials','pnts','srate','xmin', ...
        'xmax','ref','has_events','no_events','event_codes','filename','filepath','subject', 'original_file'});
